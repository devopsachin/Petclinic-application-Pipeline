	  ...
	  stage ('Test'){
        ...
        stage ('Building a container'){
			...
			sshagent (credentials: ['ssh-key']) {
		           ...
		           sh 'ssh ubuntu@ec2-52-66-15-28.ap-south-1.compute.amazonaws.com sudo docker stop pet-clinic || true'
			   sh 'ssh ubuntu@ec2-52-66-15-28.ap-south-1.compute.amazonaws.com sudo docker rm pet-clinic || true'
		           sh 'ssh -v ubuntu@ec2-52-66-15-28.ap-south-1.compute.amazonaws.com sudo docker pull 3mmmm123/pet-clinic:$BUILD_NUMBER'
			   sh 'ssh -v ubuntu@ec2-52-66-15-28.ap-south-1.compute.amazonaws.com sudo docker run -it -d --name pet-clinic -p 8080:8080 3mmmm123/pet-clinic:$BUILD_NUMBER'
                   		}
		     }
